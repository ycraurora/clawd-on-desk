...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      doctorFixConfirmCodex: "Clawd will set [features].codex_hooks = true in your Codex config. Continue?",
      doctorFixConfirmCodexTitle: "Enable Codex hooks?",
      doctorFixConfirmCodexDetail: "This repair will change your Codex config and set [features].codex_hooks = true. Clawd will not make that change unless you confirm it here.",
    ...
    zh: {
      ...
      doctorFixConfirmCodex: "Clawd 会把 Codex 配置里的 [features].codex_hooks 设为 true。继续吗？",
      doctorFixConfirmCodexTitle: "启用 Codex hooks？",
      doctorFixConfirmCodexDetail: "这次修复会修改你的 Codex 配置，把 [features].codex_hooks 设为 true。只有你在这里确认后，Clawd 才会做这个改动。",
    ...
    ko: {
      ...
      doctorFixConfirmCodex: "Clawd가 Codex 설정의 [features].codex_hooks를 true로 변경합니다. 계속할까요?",
      doctorFixConfirmCodexTitle: "Codex hooks를 켤까요?",
      doctorFixConfirmCodexDetail: "이 복구는 Codex 설정의 [features].codex_hooks를 true로 변경합니다. 여기에서 확인하기 전에는 Clawd가 이 변경을 하지 않습니다.",
    ...
    ja: {
      ...
      doctorFixConfirmCodex: "Clawd が Codex 設定の [features].codex_hooks を true にします。続行しますか？",
      doctorFixConfirmCodexTitle: "Codex hooks を有効にしますか？",
      doctorFixConfirmCodexDetail: "この修復は Codex 設定を変更し、[features].codex_hooks を true にします。ここで確認するまで、Clawd はこの変更を行いません。",
      ...
      animOverridesResetAll: "すべてデフォルトに戻す",
      animOverridesExport: "エクスポート…",
      animOverridesImport: "インポート…",
      toastAnimOverridesExportOk: (count, path) =>
